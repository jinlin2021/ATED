...
"""
This class implements a system that combines vision and language models,
specifically integrating ​​VIT (Vision Transformer)​​ for visual processing and ​​LLAMA​​ for language modeling.
...
class MiniGPT4(Blip2Base):
    ...
    def __init__(
        ...
        if self.has_qformer:
            print('Loading Q-Former') # Q-Former 结构
