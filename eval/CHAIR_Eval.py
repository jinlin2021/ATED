...
if __name__ == '__main__':
    ...
    parser.add_argument("--cap_file", type=str, default='XXX/XXXXX.jsonl',
    ...
    parser.add_argument("--coco_path", type=str, default='/XXX/XXX/XXX/MSCOCO/val2014',
                        help="only use for regenerating CHAIR evaluator object, will be ignored if uses cached evaluator.")

    parser.add_argument("--save_path", type=str, default="hallucinated_words.json",
